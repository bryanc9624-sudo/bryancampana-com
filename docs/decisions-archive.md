...
## Second batch — moved 2026-09-08

The same collapse, run again. These accumulated in `DECISIONS.md`'s closed section after
the 2026-09-07 move and were carried down for the same reason: a closed item reads as an
instruction until you reach its `[x]`, and each keeps its full original text plus line
numbers that have since drifted. Verbatim, nothing edited.
